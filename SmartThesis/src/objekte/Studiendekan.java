...
public class Studiendekan {
	...
	public Studiendekan(int id, String name, String nachname, String email, String passwort, String benutzertyp) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "Studiendekan [id=" + id + ", name=" + name + ", nachname=" + nachname + ", email=" + email
